<?php
 ...
 OR $current_user->eduyear=='' OR $current_user->specialization=='' OR $current_user->projectmanager=='' 
 OR $current_user->country_edu=='' ) {
?>
...
<div style="display: none;width: 100%;text-align: center;    padding: 21px;" id="bay"><h1 style="font-weight: bold;color:red;">Чтобы размещать проекты вам необходимо заполнить данные в личном кабинете. Если поля для создания проекта не отобразились, то обновите страницу.</h1></br>
                        ...
                        <div class="form-group__section">
                            ...
                            <div class="form-group__wrapper">
                                ...
                                <div class="form-group__wrapper_left">
                                    ...
                                    <label class="form-group__input userprofile">
...
<label id="boga" style="font-size: 18px;
    text-align: center;
    font-weight: bold;
...
<script type="text/javascript">
  ...
  $( "#dhtmlgoodies_country_vuz" ).change(function() {
