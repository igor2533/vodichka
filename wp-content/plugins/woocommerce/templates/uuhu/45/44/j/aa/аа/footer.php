...
<div id="polya" class="modal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">Не загружено!</h3>
        <a href="#close" title="Close" class="close">×</a>
      </div>
      <div class="modal-body">    
        <p>Чтобы загрузить проект необходимо заполнить все поля в личном профиле! 
</p>
      </div>
    </div>
  </div>
...
<div id="add_vuz_m" class="modal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">Заявка на добавление вуза.</h3>
        <a href="#close" title="Close" class="close">×</a>
      </div>
      <div class="modal-body">    
       <?php echo do_shortcode('[contact-form-7 id="3659" title="Vuz"]');  ?>
      </div>
    </div>
  </div>
</div>
