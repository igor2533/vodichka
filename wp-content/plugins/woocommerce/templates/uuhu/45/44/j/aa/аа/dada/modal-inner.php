...
a#borota {display: table!important;}
<?php }  ?>
<?php
...
<div>    <a id="borota" style="    background: #3b5997;
    font-size: 20px;
    padding-top: 5px;
    padding-bottom: 5px;
    padding-left: 5px;
    ...
    color: white;
    font-weight: bold;
    border-radius: 5px;display: none;" href="http://mvplan.ru/wp-admin/post.php?post=<?php echo get_the_ID(); ?>&action=edit">Редактировать</a>  </div>
