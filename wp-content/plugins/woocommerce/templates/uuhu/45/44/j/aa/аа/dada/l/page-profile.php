<?php
 ...
 if($current_user->phone=='' OR $current_user->city=='' OR $current_user->country=='' OR $current_user->edu==''
 OR $current_user->eduyear=='' OR $current_user->specialization==''  ) {
?>

<style>form#goool {
    display: none!important;
}
div#bay {display: block!important;}
...
/*echo $current_user->phone.'</br>';
  ...
  echo $current_user->country  .'</br>';
  echo $current_user->edu.'</br>';
  echo $current_user->eduyear.'</br>';
  echo $current_user->specialization  .'</br>';*/

  /*  echo $current_user->linkprofile.'</br>';
  echo $current_user->country_edu .'</br>';
   echo $current_user->user_email .'</br>';
    echo $current_user->first_name .'</br>';
*/
...
/*
 if($current_user->phone==null OR $current_user->city==null OR $current_user->country==null OR $current_user->edu==null
 OR $current_user->eduyear=null OR $current_user->specialization==null OR $current_user->projectmanager OR
    $current_user->linkprofile==null
 OR $current_user->country_edu==null ) {*/
        ...
        $project_file1 = $_POST['project-file1'];
         $project_file2 = $_POST['project-file2'];
...
$new = wp_insert_post(array(
        ...
        if (!is_wp_error($new)) {
            ...
            update_field('файл_проекта2', $project_file1, $new);
...
<style>
	label.form-group__input:hover::after {
    transition: 0.1s;
...
label.form-group__select:hover::after {
    transition: 0.1s;
    content: attr(data-title);
    background: #3daf2c;
    position: absolute;
...
input.wpcf7-form-control.wpcf7-submit {
   ...
   <section class="cabinside-info juri" style="display: none;">
                <div class="center-wrapper--min">
                    <span class="cabinside-section__heading">Профиль судьи (личный кабинет).</span>
                   <span>Уважаемые члены жюри!
Пожалуйста, перейдите в раздел Проекты для выставления оценок.
При возникновении проблем пожалуйста свяжитесь с куратором конкурса Калашниковой Марией по mkalashnikova@graphisoft.com
</span>
                </div>
            </section>
...
<?php if( current_user_can('referee') or current_user_can('referee2') or current_user_can('referee3') or current_user_can('referee4')
or current_user_can('referee5')) { ?>
<style> 
    div#bay {display: none!important;}
form#goool {display: none!important;}
label.form-group__input, label.form-group__select {
    display: none;
}
label.form-group__input.userprofile {
    display: inline-flex;
}
...
.form-group__section.boloto {
    display: none;
}

section.cabinside-info {
    display: none;
}

section.cabinside-info.juri {
...
span#select2-dhtmlgoodies_city-container {
...
span#select2-dhtmlgoodies_vuz-container {
    height: 48px!important;
    line-height: 48px!important;
    padding-left: 17px!important;
    background: #f1f3f4!important;
...
<div style="display: none;width: 100%;text-align: justify;    padding-top: 21px;padding-bottom: 30px;" id="bay"><h1 style="font-weight: bold;color:red;">Чтобы размещать проекты вам необходимо заполнить данные в личном кабинете. Если поля для создания проекта не отобразились, то обновите страницу.</h1></br>

</div>


                    <form id ="goool" style="display: block;" action="<?php echo add_query_arg('action', 'create'); ?>" method="POST" class="form" id="cabinet-form" enctype="multipart/form-data">
                        ...
                        <div class="form-group__section">
                            ...
                            <div class="form-group__wrapper">
                                ...
                                <div class="form-group__wrapper_inner">
                                    ...
                                    <label data-title="ФИО второго автора" class="form-group__input">
                            ...
                            <div class="form-group__wrapper">
                                ...
                                <label data-title="Выберите номинацию*" class="form-group__select">
                            ...
                            <div class="form-group__wrapper">
                                ...
                                <label data-title="Укажите название вашего проекта*" class="form-group__input">
                            ...
                            <div class="form-group__wrapper">
                                ...
                                <label data-title="Укажите описание вашего проекта*" class="form-group__textarea">
                            ...
                            <div class="form-group__wrapper">
                                ...
                                <div class="form-group__upload">
                                    ...
                                    <div class="form-group__upload_wrapper">
                                        <span class="form-group__upload_warning">Файлы принимаются в форматах *.png или *.jpg. Размеры планшетов для графической части проекта 1000х1400px, с разрешением не менее 150dpi, ориентация вертикальная. Не более 6 планшетов.</span>
                                        <button class="upload-btn image-file-btn" type="button">Загрузить</button>
                                        <input accept="image/jpg, image/jpeg, image/png" type="file" name="image-file-1" hidden>
                        ...
                        <div class="form-group__section">
                            ...
                            <div class="form-group__wrapper">
                                ...
                                <div class="form-group__upload">
                                    ...
                                    <label data-title="Укажите ссылку на облачное хранилище*" class="form-group__input">
    ...
    <div class="form-group__section">
                        ...
                        <div class="form-group__section">
                            ...
                            <div class="form-group__wrapper">
                                ...
                                <div class="form-group__wrapper_inner">
                                    ...
                                    <label data-title="Укажите ссылку на BIMx-модель или видеоролик" class="form-group__input">
						...
						<div class="form-group__section">
                            ...
                            <div class="form-group__wrapper">
                                ...
                                <div class="form-group__wrapper_inner">
                                    ...
                                    <label data-title="Укажите Ф.И.О. руководителя /-ей проекта" class="form-group__input">
                        ...
                        <div class="form-group__section">
                            ...
                            <button type="submit" id="razmes" class="btn btn_nomar btn--bordered">Разместить проект</button>
                        ...
                        <div class="form-group__section">
                            ...
                            <div class="form-group__wrapper">
                                ...
                                <div class="form-group__wrapper_left">
                                    ...
                                    <label data-title="Укажите ФИО*" class="form-group__input userprofile">
                                        <input   type="text" name="last_name" placeholder="ФИО*" value="<?php echo $current_user->last_name; ?>" required>
                                    </label>
                                    ...
                                    <label data-title="Выберите страну*" class="form-group__select">
...
<script type="text/javascript">
 ...
 jQuery(document).ready(function() { jQuery("#dhtmlgoodies_city").select2(); 
  ...
  jQuery(document).ready(function() { jQuery("#dhtmlgoodies_vuz").select2(); 
                                   ...
                                   <label data-title="Выберите город*" class="form-group__select">
                                        

<select id="dhtmlgoodies_city"  name="city" required>
    ...
    <?php
                                   ...
                                   <label data-title="Выберите ВУЗ*" class="form-group__select">
                                        

<select id="dhtmlgoodies_vuz"  name="edu" required>
    
    <?php
                                        if(esc_attr(get_the_author_meta('edu', $current_user->ID)) == null){
                                        
                                        ?>
                                       <option value="" selected>Выберите ВУЗ*</option>
...
<label data-title="Кликните, чтобы отправить заявку на добавление нового вуза" id="boga" style="font-size: 18px;
    text-align: center;
    font-weight: bold;
    color: green;" class="form-group__select">
<a href="#add_vuz_m" class="myclass" >Добавить мой вуз</a>
</label>
...
<script type="text/javascript">
 ...
 <label data-title="Укажите ссылку на Ваш профиль на BEHANCE" class="form-group__input">
                                        <input  type="text" name="linkprofile" placeholder="Ссылка на Ваш профиль на BEHANCE" value="<?php echo esc_attr(get_the_author_meta('linkprofile', $current_user->ID)); ?>">
                                    </label>
                                    ...
                                    <label data-title="Укажите ваш телефон*" class="form-group__input">
                                        <input type="tel" name="phone"  id="telephone" placeholder="Ваш телефон*" value="<?php echo esc_attr(get_the_author_meta('phone', $current_user->ID)); ?>" required>
                                    </label>


                                    <label data-title="Укажите ваш email*" class="form-group__input">
                                        <input type="email" name="email"  placeholder="Ваш email*" value="<?php echo esc_attr($current_user->user_email); ?>" disabled>
                                    </label>

                                    <label data-title="Укажите ваш адрес*" class="form-group__input">
                                        <input type="text" name="userpost"  placeholder="Ваш адрес*" value="<?php echo esc_attr(get_the_author_meta('userpost', $current_user->ID)); ?>" required>
                                    </label>

									<label class="yellow-checkbox">
										<input type="checkbox" name="subscribe" value="1" <?php checked( get_the_author_meta('subscribe', $current_user->ID), 1 ); ?> required><span class="custom-checkbox"></span><span>Я хотел бы получать информацию об ARCHICAD и мероприятиях, проводимых GRAPHISOFT и партнерами.</span>
									</label>                         
...
<script type="text/javascript">
  ...
  $( "#dhtmlgoodies_country" ).change(function() {
   ...
   $("#baku").val($("#dhtmlgoodies_vuz option:selected").text()) ;
                                    ...
                                    <label data-title="Укажите год выпуска*" class="form-group__input">
                                        <!-- <select name="eduyear"> -->
                                            <?php
                                    ...
                                    <label data-title="Выберите специализацию*" class="form-group__select">
 ...
 <select name="specialization"  style="max-width: 430px;
    ...
    cursor: pointer;" required>
									...
									<label data-title="Изменить пароль" class="form-group__input">
...
" style="color:red;" href="<?php echo home_url() ?>/delete-profile/">Удалить аккаунт</a>
                        ...
                        <div class="form-group__section boloto">
						...
						<div class="form-group__section">
                            ...
                            <button type="submit" class="btn btn_nomar btn--bordered">Сохранить</button>
